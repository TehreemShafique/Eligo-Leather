...
@product_router.post("/{product_id}/variants", response_model=VariantOut, status_code=status.HTTP_201_CREATED)
...
@product_router.patch("/variants/{variant_id}", response_model=VariantOut)
...
@product_router.post("/{product_id}/images", response_model=ProductImageOut, status_code=status.HTTP_201_CREATED)
...
@product_router.patch("/images/{image_id}", response_model=ProductImageOut)
